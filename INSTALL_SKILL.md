...
This repo includes two install formats:
...
Use the unpacked directory when you need to inspect or manually copy files.

## Option 1: Install the Packaged Skill
...
The skill is educational and analytical only. It should not give betting advice.
...
remain conservative and are separate from the market-context and
competition-state ingestion layers.
