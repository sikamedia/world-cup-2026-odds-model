...
worldcup_2026_data_jun26.py; a context file can override market odds, lineup
...
def _default_competition_state(home: str, away: str, mot_home: str, mot_away: str):
    ...
    return JUNE_26_COMPETITION_STATE.get(key) or competition_state_payload(
...
def main() -> None:
    ...
    print("=" * 78)
    print(f"2026 WORLD CUP - June 26 predictions ({profile.name})")
    print(f"  {profile.notes}")
    print("=" * 78)

    for home, away, host_home, heat, mot_home, mot_away, ctx in JUNE_26_MATCHES:
